...
class ITopology(Base):
    ...
    def AllIsolatedBranches(self):
        ...
        return self._get_string_array(self._lib.Topology_Get_AllIsolatedBranches)

    def AllIsolatedLoads(self):
        """(read-only) Array of all isolated load names."""
        return self._get_string_array(self._lib.Topology_Get_AllIsolatedLoads)

    def AllLoopedPairs(self):
        """(read-only) Array of all looped element names, by pairs."""
        return self._get_string_array(self._lib.Topology_Get_AllLoopedPairs)
    ...
    def BranchName(self, *args):
        ...
        # Getter
        if len(args) == 0:
            return self._get_string(self._lib.Topology_Get_BranchName())
    ...
    def BusName(self, *args):
        ...
        # Getter
        if len(args) == 0:
            return self._get_string(self._lib.Topology_Get_BusName())
